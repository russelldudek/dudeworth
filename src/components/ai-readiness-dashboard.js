...
import styles from '../styles/ai-readiness-dashboard.module.css';
              ...
              <div key={task.id} className={styles.task}>
                ...
                <div className={styles.taskActions}>
                  ...
                  <button
                    ...
                    const AIReadinessDashboard = ({ categories, cardsData, activeCategory, setActiveCategory, onCardAction, isRestrictedTier }) => {
